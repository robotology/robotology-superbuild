...
~~~
conda install -c conda-forge python pip numpy swig pybind11 qtpy pyqt pyqtwebengine pyqtgraph h5py tornado u-msgpack-python pyzmq ipython gst-plugins-good gst-plugins-bad gst-libav pyyaml
~~~

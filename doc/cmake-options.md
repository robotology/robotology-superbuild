...
| `ROBOTOLOGY_ENABLE_ROBOT_TESTING` | The robotology software packages related to robot testing. |  [`RobotTestingFramework`](https://github.com/robotology/robot-testing-framework) and [`blocktest`](https://github.com/robotology/blocktest) | `OFF` | [Documentation on Robot Testing profile.](#robot-testing)  |
 ...
 * the MATLAB bindings of the [iDynTree](https://github.com/gbionics/idyntree) library,
...
~~~
conda install -c conda-forge python numpy "swig==4.4.1" pybind11 qtpy pyqt pyqtgraph h5py tornado u-msgpack-python pyzmq ipython
~~~
